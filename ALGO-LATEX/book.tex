...
{\bf Problem statement} Given a square grid consisting of $L\times L$ unit cells, colour $0 \leq N \leq L^2$ cells such that the perimeter of the coloured cells is maximized.
...
This covers all cases, because if we have removed all possible interior cells and borner cells, we have arrived at the chessboard pattern.
