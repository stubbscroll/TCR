...
{\bf Problem statement} Given a square grid consisting of $L\times L$ unit cells and a given integer $0 \ leq N <\leq N^2$, colour $N$ cells such that the perimeter of the coloured cells is maximized. What is the length of the perimeter?
